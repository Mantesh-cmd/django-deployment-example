...
from .forms import UserForm,Profile_Info
...
def django(request):
    return render(request,'myapp/dj.html')
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        profile_form = Profile_Info(data = request.POST)
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            print(user_form.errors,profile_form.erors)
